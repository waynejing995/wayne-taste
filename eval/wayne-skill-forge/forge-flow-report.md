# Forge static-validation Flow hotfix

The candidate tree is
`e053ca980fc0e8d0a97ab8add62361c07d7230864bfe1ed7348e2a7212531cab`
(262 lines / 2056 words). Forge validates itself with 0 errors and the existing two
size warnings.
...
- Calibration: PASS; missing decision, missing failure edge, missing success edge,
  and direct static-to-behavior bypass are all rejected.
- Same malformed-child task:

| Model | Static validator | Behavioral smoke | Child mutation | Semantic gate |
|---|---|---|---|---|
...
Residual uncertainty: this targeted hotfix exercises the static-failure branch,
