...
MUTATIONS: list[tuple[str, str]] = [
    ...
    ("frontend routing", "wayne-frontend-design skill for big UI change"),
    ...
    ("harness gates earned", "First layer, up front"),
    ("harness gates earned", "bought by real data"),
    ("harness gates earned", "never delete it for not firing"),
