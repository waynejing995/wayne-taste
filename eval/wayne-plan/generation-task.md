Use the Wayne Skill Forge at `/workspace/forge` to revise the existing skill in
`/workspace/skill` against `/workspace/intent.md`. Forge is self-contained; do not
load or rely on any external skill-creator.

Write the complete candidate skill to `/workspace/out/wayne-plan`. Preserve the
