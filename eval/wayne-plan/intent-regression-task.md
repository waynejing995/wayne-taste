...
resource it requires. Use only that supplied planning skill.

Work in `/workspace/repo` and create the implementation plan for the approved
idempotent delivery retry feature. Discover and read the decision log, spec, matrix,
