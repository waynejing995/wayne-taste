...
state=$(realpath -m "$3")
mkdir -p "$state/cache" "$state/session-env" "$state/codex-home"
...
common=(
    ...
    --setenv WAYNE_REVIEW_OUTPUT_DIR /workspace/review-evidence
    --setenv WAYNE_CLAUDE_MODEL opus
    --setenv WAYNE_CODEX_MODEL dvue-aoai-001-gpt-5.6-sol
)
