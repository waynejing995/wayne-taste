...
| CR02 | Read plan/spec intent and check planned-missing plus diff-unplanned in both directions | `0888631:wayne-code-review/SKILL.md:103-112,426-431` | intended | intent playbook | blind source-fidelity review plus frozen source bytes/hashes | dataflow + candidate-static | PASS |
...
| CR09 | Preserve orphan producer, dead consumer, semantic drift, dual path, and half migration checks | `e624257:wayne-code-review/SKILL.md:160-226` | intended | dataflow playbook | blind dataflow review; static scans are reviewer observations | dataflow + candidate-static | PASS |
...
| CR11 | Apply architecture/state-owner lens only to structural diffs | `bcce934:wayne-code-review/SKILL.md`; current optional lens | intended | architecture playbook | blind applicability/state-owner review | candidate-static | PASS |
