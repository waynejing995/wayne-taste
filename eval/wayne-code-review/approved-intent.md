...
| CR13 | Review-only requests never modify code, index, refs, tests, or checkpoint state | current auto-fix conflict; repository review boundary | control defect | main/workers | fixture manifest, HEAD/index/refs, commit count, and adapter before/after hash remain unchanged | all behavior cases | PASS |
