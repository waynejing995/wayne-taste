...
| `wayne-compound` | Post-mortem KB entries at `WAYNE_KB_DIR` from `~/.wayne/config.env` after a hard problem solved | Don't write incident lessons in CLAUDE.md or memory; route to compound |
