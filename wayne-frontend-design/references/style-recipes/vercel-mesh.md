...
**Shadow**: minimal at component level; the _page_ feels lit by the gradient mesh, not by shadows.
...
- Bright saturated purple → pink gradients (that's the AI cliché the recipe is _replacing_)
